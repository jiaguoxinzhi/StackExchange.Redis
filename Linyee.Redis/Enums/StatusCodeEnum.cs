...
namespace WS_Core.Enums
{
    ...
    public enum StatusCodeEnum
    {
        ...
        #region Member 300xxx
        /// <summary>
        /// 会员未找到
        /// </summary>
        [Description("会员未找到")]
        Member_Not_Found = 300404,
        /// <summary>
        /// 会员状态异常
        /// </summary>
        [Description("会员状态异常")]
        Member_Status_Exception = 301500,
        /// <summary>
        /// 会员旧密码不正确
        /// </summary>
        [Description("会员旧密码不正确")]
        Member_Baid_Old_Password = 302500,
        /// <summary>
        /// 会员认证失败或密码错误
        /// </summary>
        [Description("会员认证失败或密码错误")]
        Member_Not_Valid = 303500,
        /// <summary>
        /// 会员登录成功
        /// </summary>
        [Description("会员登录成功")]
        Member_Login_Ok = 301200,
        #endregion

        #region Api 1000xxx
        /// <summary>
        /// 无权访问Api，没有足够的权限访问该资源
        /// </summary>
        [Description("无权访问Api")]
        Api_NonRight_Access = 1000501,
        #endregion
    }
}
